...
export async function saveFileLocalFromBuffer(file: Express.Multer.File, payload: any) {
  // Fayl extension aniqlash
  let ext = path.extname(file.originalname) || '.' + file.mimetype.split('/')[1] || '.bin';
