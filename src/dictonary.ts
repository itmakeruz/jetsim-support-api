...
export const download_description = {
  uz: '🔗* Ilovani yuklab olish uchun havola*',
...
export const success_txt = {
  uz: 'Qabul qilindi operator javobini kuting',
  ru: 'Получил, дождитесь ответа оператора',
  en: "Received, wait for the operator's response",
};
...
export const file_size_error = {
  uz: 'Maksimal fayl hajmi 100 mb',
  ru: 'Максимальный размер файла 100 МБ',
  en: 'Maximum file size 100 mb',
};
export const already_ticket_error = {
  uz: 'Bu ticket allaqachon ochilgan',
  ru: 'Этот тикет уже открыт',
  en: 'This ticket has already been opened',
};
export const auth_error = {
  uz: "Login yoki parol noto'g'ri",
  ru: 'Неправильный логин или пароль',
  en: 'Login or password incorret',
};
...
export const message_notfound = {
  uz: 'Javob berilgan xabar identifikatorida xabar topilmadi',
  ru: 'Сообщение не найдено по идентификатору сообщения, на которое был дан ответ.',
  en: 'A message was not found by the message ID that was answered',
};
export const ticket_opened_error = {
  uz: 'Bu ticket boshqa operator tomonidan ochilgan',
  ru: 'Этот тикет был открыт другим оператором',
  en: 'This ticket was opened by another operator',
};
export const unable_user_error = {
  uz: "Noma'lum foydalanuvchiga yozish imkonsiz",
  ru: 'Невозможно написать неопределенному пользователю',
  en: 'Unable to write to unspecified user',
};
export const success = { uz: 'Muvaffaqiyatli', ru: 'Успешный', en: 'Success' };
export const user_blocked = {
  uz: 'Foydalanuvchi botni blocklagani sabab xabar yetkazilmadi',
  ru: 'Сообщение не было доставлено, поскольку пользователь заблокировал бота.',
  en: 'The message was not delivered because the user blocked the bot',
};
export const _user_blocked = {
  uz: 'Foydalanuvchi botni blocklagan',
  ru: 'Пользователь заблокировал бота',
  en: 'The user blocked the bot',
};
export const else_message = {
  uz: "Xurmatli mijoz agar savolingiz bo'lsa *📞 Aloqa* tugmasini bosing",
  ru: 'Уважаемый покупатель, если у вас есть вопросы, нажмите кнопку *📞 Контакты*',
  en: 'Dear customer, if you have any questions, please click the *📞 Contact* button.',
};
...
export const defaultMessages = {
  ...
  9: {
    uz: 'Assalomu alaykum. Men Agrobank Mobile uchun yaratilgan suniy intelektman.\n\nBu bo’limda sizga kreditlar haqida ma’lumotlar bera olaman ilitmos o’zingizni qiziqtirgan savollarni aniqroq qilib bersangiz men sizga yordam berishga tayyorman!',
    ru: 'Привет. Я искусственный интеллект, созданный для приложения Agrobank Mobile.\nВ этом разделе я могу предоставить Вам информацию по кредитам. Уточните, пожалуйста, интересующие Вас вопросы. Готов Вам помочь!',
    en: 'Hello. I am an artificial intelligence created for the Agrobank Mobile application.\nIn this section, I can provide you with information about loans. Please clarify the questions you are interested in. I am ready to help you!',
  },
};
